...
import { BarChart3, BriefcaseIcon, CheckSquare, Clock, Shield, Users } from "lucide-react"
...
export function AdminSidebar({ activeView, setActiveView }: AdminSidebarProps) {
  const navItems = [
    ...
    },
    {
      ...
      label: "Review Queue",
      view: "review-queue" as ActiveView,
    },
    {
  ...
  return (
    <aside className="hidden w-16 flex-col border-r border-gray-200 bg-white md:flex lg:w-64">
      <div className="flex h-16 items-center justify-center border-b px-4">
        <h2 className="hidden text-lg font-bold lg:block">Admin Portal</h2>
        <Shield className="h-6 w-6 text-blue-500 lg:hidden" />
      </div>
